...
setup(
    ...
    author='Eklipsorz',  # Type in your name
    author_email='eklipsorz@protonmail.ch',  # Type in your E-Mail
    url='https://github.com/Eklipsorz/roam-to-git',
    download_url='https://github.com/Eklipsorz/roam-to-git/archive/v0.1.tar.gz',
